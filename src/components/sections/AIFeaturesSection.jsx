    ...
    visual: (
      <div className="relative w-full h-[420px] flex items-center justify-center">
        ...
        <div className="absolute right-0 top-8 w-56 h-72 bg-white shadow-ledger rotate-2 overflow-hidden">
          <div className="w-full h-56 bg-gradient-to-br from-amber-300 via-orange-400 to-red-500 opacity-70" />
          <div className="p-3">
            <p className="font-serif italic text-xs text-ink-light text-center">Pashupatinath Temple</p>
          </div>
        </div>
    ...
    visual: (
      <div className="relative w-full h-[420px] flex items-center justify-center">
        ...
        <div className="absolute left-4 top-8 w-28 h-36 bg-white shadow-pin p-2 -rotate-9 overflow-hidden">
          <div className="w-full h-24 bg-gradient-to-br from-blue-300 to-indigo-400 opacity-70" />
        ...
        <div className="absolute right-4 bottom-12 w-32 h-40 bg-white shadow-pin p-2 rotate-4 overflow-hidden">
          <div className="w-full h-28 bg-gradient-to-br from-green-300 to-teal-400 opacity-70" />
    ...
    visual: (
      <div className="relative w-full h-[420px] grid grid-cols-2 gap-4">
        ...
        <div className="relative rounded-2xl border-4 border-[rgba(212,232,211,0.2)] overflow-hidden">
          <div className="w-full h-full bg-gradient-to-b from-amber-800 to-amber-950">
        ...
        <div className="relative rounded-2xl border-4 border-[rgba(212,232,211,0.2)] overflow-hidden mt-16">
          <div className="w-full h-full bg-gradient-to-b from-blue-900 to-indigo-950">
            <div className="absolute bottom-4 left-4 text-white">
